...
SECRET_KEY = 'django-insecure-=qpb_q@(n+#s#d26(6kuabw#9jbh!ic1hp#bg#v+p7$qxy5tt8'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'form_demo/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIR = [
	os.path.join(BASE_DIR, 'static'),  # produce absolute path
]
